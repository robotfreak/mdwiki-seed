...
* Ultraschallsensor, siehe [Ultraschallsensor](ultrasonic.md)
* Servo und Pan/Tilt Kopf, siehe [Roboter Kopf mit Servo Pan Tilt](servo-pan-tilt.md)

### Schaltplan

![Verdrahtung](../../images/circ/radar_Steckplatine.png)
